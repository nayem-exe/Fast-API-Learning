...
class Patient(BaseModel):
    ...
    gender: Annotated[str,Literal['male','female'], Field(..., description='Gender of the patient')]
...
def get_patient(patient_id: str = Path(..., description="The ID of the patient you want to view", example="P001")):
    #load all patients 
    data = load_data()
